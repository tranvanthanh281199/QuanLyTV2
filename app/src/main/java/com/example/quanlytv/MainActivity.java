...
public class MainActivity extends AppCompatActivity
    ...
    Button btnSach, btnTacGia, btnTheLoai, btnNhanVien, btnDocGia, btnTab;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSach.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, QLSach.class);
        ...
        btnTacGia.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, QLTacGia.class);
                startActivity(intent);
        ...
        btnTheLoai.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, QLTheLoai.class);
                startActivity(intent);
